...
def viborZvena(): #подбор звена
    ...
    while needNewChoice:
        ...
        if userInput.isdigit(): #отсеивает по типу данных(инт)
            needNewChoice=False
...
[y,x] = matlab.step(unit,timeLine)  #построение графиков
